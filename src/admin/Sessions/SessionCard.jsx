    ...
    <div className="bg-white p-3 rounded-2xl shadow flex flex-col">
      <div className=" flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          {/* <Link to={`/admin/sessions/levels/${session.code}`}>
      ...
      <div className="flex flex-col items-start justify-between h-full">
        <div>
          <p className="text-lg font-bold text-gray-700">{session?.name}</p>
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="w-60 text-center text-gray-600">
            Deleting this session cannot be undone. All Values associated with
